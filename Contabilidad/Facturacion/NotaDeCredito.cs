...
namespace Contabilidad
{
    public partial class NotaDeCredito : Form
    {
        ...
        public static NotaDeCredito creditoForm;
        ...
        void comboMotivo()
        {
            cmb_Motivo.DataSource = objContabilidadDocuDAO.listarMotivoNotaCredito();
            cmb_Motivo.ValueMember = "TNCreditoCod";
            cmb_Motivo.DisplayMember = "TNCreditoDescripcion";
            cmb_Motivo.Refresh();
        }
        ...
        {
            limpiarCampos();
            txt_Numero.Text = objDocumento.correlativoFactura("07", Ventas.UNIDADNEGOCIO, txt_Serie.Text);
        ...
        private void btn_Buscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (var buscarDocumentoForm = new BuscarDocumento(cmb_TipoDocumento.SelectedValue.ToString(), "C"))
                {
        ...
        {
            using (var buscarProductoForm = new BuscarProducto("NC"))
            {
