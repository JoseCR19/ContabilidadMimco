...
{
    public partial class ListaNotaCredito : Form
    {
        DocumentoDAO objDocumentoDao;
        public static ListaNotaCredito formListaCredito;
        ...
        public ListaNotaCredito()
        {
            ...
            objMoneda.tipoCambio();
            formListaCredito = this;
            gridParams();
            cmbEstado();
            ...
            objListaDocumentoCab = objDocumentoDao.listarCabecera(d1, d2, txt_Ruc.Text, "07", Ventas.UNIDADNEGOCIO);
        ...
        private void btn_Nuevo_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            operacionFactura = "N";
            NotaDeCredito Check = new NotaDeCredito();
            Check.Show();
        ...
        private void btn_Buscar_Click(object sender, EventArgs e)
        {
            ...
            grd_Facturas.DataSource = null;
            objListaDocumentoCab = objDocumentoDao.listarCabecera(dpickerInicio.Value, dpickerFin.Value, txt_Ruc.Text, "07", Ventas.UNIDADNEGOCIO);
            grd_Facturas.DataSource = objListaDocumentoCab;
            grd_Facturas.Refresh();
            sumatorias();
        ...
        {
            this.Hide();
            Ventas.formVentas.setEnabledItems("C");
        }
        ...
        private void formatearFactura(String qr)
        {
            ...
            if (objListDocumentoDet.Count > 0)
            {
                for (int i = 0; i < objListDocumentoDet.Count; i++)
                {
                    ...
                    objNotaReporte.Motivo = objDocumentoCab.DocumentoCabNotaCredito;
                    objNotaReporte.Tipo = "la Nota de Crédito Electrónica";
   ...
   + objDocumentoCab.DocumentoCabTotal.ToString("C").Substring(3).Trim() + "|" + objDocumentoCab.DocumentoCabFecha.ToString("dd-MM-yyyy") + "|" + "6|" + objDocumentoCab.DocumentoCabClienteDocumento + "|";
                ...
                formatearFactura(qr);
                ReporteView Check = new ReporteView("LC"); // listar nota credito
                Check.Show();
   ...
   + objDocumentoCab.DocumentoCabTotal.ToString("C").Substring(3).Trim() + "|" + objDocumentoCab.DocumentoCabFecha.ToString("dd-MM-yyyy") + "|" + "6|" + objDocumentoCab.DocumentoCabClienteDocumento + "|";
        ...
        private void btn_Anular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var form = new MotivoAnulacion("C"))
                {
                    form.ShowDialog();
                }
            }
   ...
   + objDocumentoCab.DocumentoCabTotal.ToString("C").Substring(3).Trim() + "|" + objDocumentoCab.DocumentoCabFecha.ToString("dd-MM-yyyy") + "|" + "6|" + objDocumentoCab.DocumentoCabClienteDocumento + "|";
        ...
        private void btn_ConsultarMasivo_Click(object sender, EventArgs e)
        {
            ...
            objListConsulta = objDocumentoDao.listarDocumentosPorConsultar("07",Ventas.UNIDADNEGOCIO);
