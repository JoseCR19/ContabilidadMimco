...
{
    public partial class NotaCreditoReporte : Form
    {
        ...
        public NotaCreditoReporte(String tipoDocu, String tipoReport)
        {
            InitializeComponent();
            ...
            this.Text = "REPORTE NOTA DE CRÉDITO";
            gridParams();
            if (tipoReporte == "F")
            {
                ...
                txt_Motivo.Text = ReporteDocumentosPorFecha.objDocumentoCab.DocumentoCabNotaCredito;
            ...
            }else if (tipoReporte == "C")
            {
                ...
                txt_Motivo.Text = ReporteDocumentosPorCliente.objDocumentoCab.DocumentoCabNotaCredito;
        ...
        private void btn_Reporte_Click(object sender, EventArgs e)
        {
            ...
            formatearFactura(qr);
            ReporteView Check = new ReporteView("CF"); // NC fecha
            Check.Show();
